...
interface SoundDropButtonProps {
  soundDrop: MusicTrack
  isPlaying: boolean
  onTrigger: (soundDrop: MusicTrack) => void
}

export function SoundDropButton({ soundDrop, isPlaying, onTrigger }: SoundDropButtonProps) {
  return (
    <button
      onClick={() => onTrigger(soundDrop)}
