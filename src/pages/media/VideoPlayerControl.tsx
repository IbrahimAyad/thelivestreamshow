...
import { VideoCard } from '@/components/media/video-player/VideoCard';
import { QueueItem } from '@/components/media/video-player/QueueItem';
import { RecommendationCard } from '@/components/media/video-player/RecommendationCard';
import { AnalyticsPanel } from '@/components/media/video-player/AnalyticsPanel';
import { SchedulingModal } from '@/components/media/video-player/SchedulingModal';
import { ImageUploadZone } from '@/components/media/image-player/ImageUploadZone';
import { ImageQueueCard } from '@/components/media/image-player/ImageQueueCard';
import { ImageDisplayControls } from '@/components/media/image-player/ImageDisplayControls';
import { ImageHistory } from '@/components/media/image-player/ImageHistory';
import { MonitorTab } from '@/components/media/monitor/MonitorTab';
import { supabase } from '@/lib/supabase';
import { VideoRecommendation, VideoCategory, YouTubeVideo } from '@/types/video';
import { searchYouTubeVideos, generateRecommendations } from '@/lib/media/youtube';
